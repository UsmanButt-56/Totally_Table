        ...
        <div className="">
            <div className='flex flex-col lg:flex-row lg:justify-between font-normal lg:items-center'>
                ...
                <div className='flex items-center px-0 lg:px-[23px] gap-[46px]'>
                    ...
                    <div className='flex justify-between border-2 border-[#707070] items-center px-[9px] sm:px-[18px] md:px-[18px] lg:px-[23px]'>
                        <div className='w-[100px] sm:w-[130px] md:w-[250px] lg:w-[309px] flex italic text-[14px] sm:text-[18px] md:text-[24px] font-mulish tracking-[0.48px] text-[#F2F0EF] h-[35px] md:h-[73px]'>
